...
function csetup (status, funit, iout, io_buffer, n, m, x, bl, bu, v, cl, cu,
  ...
  ccall(("cutest_csetup_", libname), Void,
    ...
    status, funit, iout, io_buffer, n, m, x, bl, bu, v, cl, cu, equatn, linear,
...
function cstats (status, nonlinear_variables_objective,
  ...
  ccall(("cutest_cstats_", libname), Void,
    ...
    status, nonlinear_variables_objective, nonlinear_variables_constraints,
...
function ubandh (status, n, x, nsemib, bandh, lbandh, maxsbw, libname =
  ...
  ccall(("cutest_ubandh_", libname), Void,
    (Ptr{Int32}, Ptr{Int32}, Ptr{Float64}, Ptr{Int32}, Ptr{Float64}, Ptr{Int32},
    Ptr{Int32}),
...
function ueh (status, n, x, ne, le, iprnhi, iprhi, lirnhi, irnhi, lhi, hi,
  ...
  ccall(("cutest_ueh_", libname), Void,
    ...
    Ptr{Int32}, Ptr{Int32}, Ptr{Int32}, Ptr{Int32}, Ptr{Float64}, Ptr{Int32}),
...
function ugrdh (status, n, x, g, lh1, h, libname = fixedlibname)
  ccall(("cutest_ugrdh_", libname), Void,
    (Ptr{Int32}, Ptr{Int32}, Ptr{Float64}, Ptr{Float64}, Ptr{Int32},
    Ptr{Float64}),
    status, n, x, g, lh1, h)
end
...
function cgr (status, n, m, x, v, grlagf, g, jtrans, lcjac1, lcjac2, cjac,
  ...
  ccall(("cutest_cgr_", libname), Void,
    (Ptr{Int32}, Ptr{Int32}, Ptr{Int32}, Ptr{Float64}, Ptr{Float64}, Ptr{Int32},
    Ptr{Float64}, Ptr{Int32}, Ptr{Int32}, Ptr{Int32}, Ptr{Float64}),
...
function cgrdh (status, n, m, x, v, grlagf, g, jtrans, lcjac1, lcjac2, cjac,
  ...
  ccall(("cutest_cgrdh_", libname), Void,
    (Ptr{Int32}, Ptr{Int32}, Ptr{Int32}, Ptr{Float64}, Ptr{Float64}, Ptr{Int32},
    Ptr{Float64}, Ptr{Int32}, Ptr{Int32}, Ptr{Int32}, Ptr{Float64}, Ptr{Int32},
    Ptr{Float64}),
...
function ceh (status, n, m, x, lv, v, ne, le, iprnhi, iprhi, lirnhi, irnhi, lhi,
  ...
  ccall(("cutest_ceh_", libname), Void,
    (Ptr{Int32}, Ptr{Int32}, Ptr{Int32}, Ptr{Float64}, Ptr{Int32}, Ptr{Float64},
    Ptr{Int32}, Ptr{Int32}, Ptr{Int32}, Ptr{Int32}, Ptr{Int32}, Ptr{Int32},
    Ptr{Int32}, Ptr{Float64}, Ptr{Int32}),
    status, n, m, x, lv, v, ne, le, iprnhi, iprhi, lirnhi, irnhi, lhi, hi,
    byrows)
end
...
function csgrsh (status, n, m, x, v, grlagf, nnzj, lcjac, cjac, indvar, indfun,
  ...
  ccall(("cutest_csgrsh_", libname), Void,
    ...
    Ptr{Int32}, Ptr{Int32}, Ptr{Float64}, Ptr{Int32}, Ptr{Int32}, Ptr{Int32},
    Ptr{Int32}, Ptr{Float64}, Ptr{Int32}, Ptr{Int32}),
    status, n, m, x, v, grlagf, nnzj, lcjac, cjac, indvar, indfun, nnzh, lh, h,
    irnh, icnh)
end
...
function csgreh (status, n, m, x, v, grlagf, nnzj, lcjac, cjac, indvar, indfun,
  ...
  ccall(("cutest_csgreh_", libname), Void,
    ...
    Ptr{Int32}, Ptr{Int32}, Ptr{Int32}, Ptr{Int32}, Ptr{Int32}, Ptr{Int32},
    Ptr{Float64}, Ptr{Int32}),
    status, n, m, x, v, grlagf, nnzj, lcjac, cjac, indvar, indfun, ne, le,
