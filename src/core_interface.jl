function usetup(io_err::Array{Cint, 1}, input::Array{Cint, 1},
    out::Array{Cint, 1}, io_buffer::Array{Cint, 1}, n::Array{Cint, 1},
...
function csetup(io_err::Array{Cint, 1}, input::Array{Cint, 1},
    out::Array{Cint, 1}, io_buffer::Array{Cint, 1}, n::Array{Cint, 1},
    m::Array{Cint, 1}, x::Array{Cdouble, 1}, x_l::Array{Cdouble, 1},
    x_u::Array{Cdouble, 1}, y::Array{Cdouble, 1}, c_l::Array{Cdouble, 1},
    c_u::Array{Cdouble, 1}, equatn::Array{Cint, 1}, linear::Array{Cint,
    1}, e_order::Array{Cint, 1}, l_order::Array{Cint, 1},
    v_order::Array{Cint, 1}, libname = fixedlibname)
...
function udimen(io_err::Array{Cint, 1}, input::Array{Cint, 1},
    n::Array{Cint, 1}, libname = fixedlibname)
...
function udimse(io_err::Array{Cint, 1}, ne::Array{Cint, 1},
    he_val_ne::Array{Cint, 1}, he_row_ne::Array{Cint, 1}, libname =
    fixedlibname)
...
function uvartype(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x_type::Array{Cint, 1}, libname = fixedlibname)
  @eval ccall(("cutest_uvartype_", $(libname)), Void,
    (Ptr{Cint}, Ptr{Cint}, Ptr{Cint}),
    $(io_err), $(n), $(x_type))
end

function unames(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    pname::Array{Cchar, 1}, vname::Array{Cchar, 1}, libname =
    fixedlibname)
...
function ureport(io_err::Array{Cint, 1}, calls::Array{Cdouble, 1},
    time::Array{Cdouble, 1}, libname = fixedlibname)
  @eval ccall(("cutest_ureport_", $(libname)), Void,
    (Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}),
    $(io_err), $(calls), $(time))
end

function cdimen(io_err::Array{Cint, 1}, input::Array{Cint, 1},
    n::Array{Cint, 1}, m::Array{Cint, 1}, libname = fixedlibname)
...
function cdimse(io_err::Array{Cint, 1}, ne::Array{Cint, 1},
    he_val_ne::Array{Cint, 1}, he_row_ne::Array{Cint, 1}, libname =
    fixedlibname)
...
function cstats(io_err::Array{Cint, 1},
    nonlinear_variables_objective::Array{Cint, 1},
...
function cvartype(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x_type::Array{Cint, 1}, libname = fixedlibname)
...
function cnames(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    m::Array{Cint, 1}, pname::Array{Cchar, 1}, vname::Array{Cchar, 1},
    cname::Array{Cchar, 1}, libname = fixedlibname)
...
function creport(io_err::Array{Cint, 1}, calls::Array{Cdouble, 1},
    time::Array{Cdouble, 1}, libname = fixedlibname)
...
function connames(io_err::Array{Cint, 1}, m::Array{Cint, 1},
    cname::Array{Cchar, 1}, libname = fixedlibname)
...
function pname(io_err::Array{Cint, 1}, input::Array{Cint, 1},
    pname::Array{Cchar, 1}, libname = fixedlibname)
...
function varnames(io_err::Array{Cint, 1}, n::Array{Cint, 1},
...
function ufn(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, f::Array{Cdouble, 1}, libname = fixedlibname)
  @eval ccall(("cutest_ufn_", $(libname)), Void,
    (Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}),
    $(io_err), $(n), $(x), $(f))
end

function ugr(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, g::Array{Cdouble, 1}, libname = fixedlibname)
  @eval ccall(("cutest_ugr_", $(libname)), Void,
    (Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}),
    $(io_err), $(n), $(x), $(g))
end

function uofg(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, f::Array{Cdouble, 1}, g::Array{Cdouble, 1},
...
function ubandh(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, semibandwidth::Array{Cint, 1},
    h_band::Array{Cdouble, 2}, lbandh::Array{Cint, 1},
    max_semibandwidth::Array{Cint, 1}, libname = fixedlibname)
...
function udh(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, lh1::Array{Cint, 1}, h::Array{Cdouble, 2},
    libname = fixedlibname)
...
function ush(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, nnzh::Array{Cint, 1}, lh::Array{Cint, 1},
...
function ueh(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, ne::Array{Cint, 1}, lhe_ptr::Array{Cint, 1},
...
function ugrdh(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, g::Array{Cdouble, 1}, lh1::Array{Cint, 1},
    h::Array{Cdouble, 2}, libname = fixedlibname)
...
function ugrsh(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, g::Array{Cdouble, 1}, nnzh::Array{Cint, 1},
...
function ugreh(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, g::Array{Cdouble, 1}, ne::Array{Cint, 1},
...
function uhprod(io_err::Array{Cint, 1}, n::Array{Cint, 1},
...
function cfn(io_err::Array{Cint, 1}, n::Array{Cint, 1}, m::Array{Cint,
    1}, x::Array{Cdouble, 1}, f::Array{Cdouble, 1}, c::Array{Cdouble, 1},
    libname = fixedlibname)
...
function cofg(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, f::Array{Cdouble, 1}, g::Array{Cdouble, 1},
    grad::Array{Cint, 1}, libname = fixedlibname)
...
function cofsg(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, f::Array{Cdouble, 1}, nnzg::Array{Cint, 1},
    lg::Array{Cint, 1}, g_val::Array{Cdouble, 1}, g_var::Array{Cint, 1},
    grad::Array{Cint, 1}, libname = fixedlibname)
...
function ccfg(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    m::Array{Cint, 1}, x::Array{Cdouble, 1}, c::Array{Cdouble, 1},
    jtrans::Array{Cint, 1}, lcjac1::Array{Cint, 1}, lcjac2::Array{Cint,
    1}, cjac::Array{Cdouble, 2}, grad::Array{Cint, 1}, libname =
    fixedlibname)
...
function clfg(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    m::Array{Cint, 1}, x::Array{Cdouble, 1}, y::Array{Cdouble, 1},
...
function cgr(io_err::Array{Cint, 1}, n::Array{Cint, 1}, m::Array{Cint,
    1}, x::Array{Cdouble, 1}, y::Array{Cdouble, 1}, grlagf::Array{Cint,
    1}, g::Array{Cdouble, 1}, jtrans::Array{Cint, 1}, lj1::Array{Cint, 1},
...
function csgr(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    m::Array{Cint, 1}, x::Array{Cdouble, 1}, y::Array{Cdouble, 1},
    grlagf::Array{Cint, 1}, nnzj::Array{Cint, 1}, lj::Array{Cint, 1},
    j_val::Array{Cdouble, 1}, j_var::Array{Cint, 1}, j_fun::Array{Cint,
    1}, libname = fixedlibname)
...
function ccfsg(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    m::Array{Cint, 1}, x::Array{Cdouble, 1}, c::Array{Cdouble, 1},
    nnzj::Array{Cint, 1}, lj::Array{Cint, 1}, j_val::Array{Cdouble, 1},
    j_var::Array{Cint, 1}, j_fun::Array{Cint, 1}, grad::Array{Cint, 1},
    libname = fixedlibname)
...
function ccifg(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    icon::Array{Cint, 1}, x::Array{Cdouble, 1}, ci::Array{Cdouble, 1},
    gci::Array{Cdouble, 1}, grad::Array{Cint, 1}, libname = fixedlibname)
...
function ccifsg(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    icon::Array{Cint, 1}, x::Array{Cdouble, 1}, ci::Array{Cdouble, 1},
    nnzgci::Array{Cint, 1}, lgci::Array{Cint, 1}, gci_val::Array{Cdouble,
    1}, gci_var::Array{Cint, 1}, grad::Array{Cint, 1}, libname =
    fixedlibname)
...
function cgrdh(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    m::Array{Cint, 1}, x::Array{Cdouble, 1}, y::Array{Cdouble, 1},
    grlagf::Array{Cint, 1}, g::Array{Cdouble, 1}, jtrans::Array{Cint, 1},
    lj1::Array{Cint, 1}, lj2::Array{Cint, 1}, j_val::Array{Cdouble, 2},
    lh1::Array{Cint, 1}, h_val::Array{Cdouble, 2}, libname = fixedlibname)
...
function cdh(io_err::Array{Cint, 1}, n::Array{Cint, 1}, m::Array{Cint,
    1}, x::Array{Cdouble, 1}, y::Array{Cdouble, 1}, lh1::Array{Cint, 1},
...
function csh(io_err::Array{Cint, 1}, n::Array{Cint, 1}, m::Array{Cint,
    1}, x::Array{Cdouble, 1}, y::Array{Cdouble, 1}, nnzh::Array{Cint, 1},
    lh::Array{Cint, 1}, h_val::Array{Cdouble, 1}, h_row::Array{Cint, 1},
    h_col::Array{Cint, 1}, libname = fixedlibname)
...
function cshc(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    m::Array{Cint, 1}, x::Array{Cdouble, 1}, y::Array{Cdouble, 1},
...
function ceh(io_err::Array{Cint, 1}, n::Array{Cint, 1}, m::Array{Cint,
    1}, x::Array{Cdouble, 1}, y::Array{Cdouble, 1}, ne::Array{Cint, 1},
    lhe_ptr::Array{Cint, 1}, he_row_ptr::Array{Cint, 1},
    he_val_ptr::Array{Cint, 1}, lhe_row::Array{Cint, 1},
    he_row::Array{Cint, 1}, lhe_val::Array{Cint, 1},
    he_val::Array{Cdouble, 1}, byrows::Array{Cint, 1}, libname =
...
function cidh(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, iprob::Array{Cint, 1}, lh1::Array{Cint, 1},
    h::Array{Cdouble, 2}, libname = fixedlibname)
...
function cish(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    x::Array{Cdouble, 1}, iprob::Array{Cint, 1}, nnzh::Array{Cint, 1},
    lh::Array{Cint, 1}, h_val::Array{Cdouble, 1}, h_row::Array{Cint, 1},
    h_col::Array{Cint, 1}, libname = fixedlibname)
...
function csgrsh(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    m::Array{Cint, 1}, x::Array{Cdouble, 1}, y::Array{Cdouble, 1},
    grlagf::Array{Cint, 1}, nnzj::Array{Cint, 1}, lj::Array{Cint, 1},
    j_val::Array{Cdouble, 1}, j_var::Array{Cint, 1}, j_fun::Array{Cint,
    1}, nnzh::Array{Cint, 1}, lh::Array{Cint, 1}, h_val::Array{Cdouble,
    1}, h_row::Array{Cint, 1}, h_col::Array{Cint, 1}, libname =
    fixedlibname)
...
function csgreh(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    m::Array{Cint, 1}, x::Array{Cdouble, 1}, y::Array{Cdouble, 1},
    grlagf::Array{Cint, 1}, nnzj::Array{Cint, 1}, lj::Array{Cint, 1},
    j_val::Array{Cdouble, 1}, j_var::Array{Cint, 1}, j_fun::Array{Cint,
    1}, ne::Array{Cint, 1}, lhe_ptr::Array{Cint, 1},
    he_row_ptr::Array{Cint, 1}, he_val_ptr::Array{Cint, 1},
    lhe_row::Array{Cint, 1}, he_row::Array{Cint, 1}, lhe_val::Array{Cint,
    1}, he_val::Array{Cdouble, 1}, byrows::Array{Cint, 1}, libname =
    fixedlibname)
...
function chprod(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    m::Array{Cint, 1}, goth::Array{Cint, 1}, x::Array{Cdouble, 1},
    y::Array{Cdouble, 1}, vector::Array{Cdouble, 1},
    result::Array{Cdouble, 1}, libname = fixedlibname)
...
function chcprod(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    m::Array{Cint, 1}, goth::Array{Cint, 1}, x::Array{Cdouble, 1},
    y::Array{Cdouble, 1}, vector::Array{Cdouble, 1},
    result::Array{Cdouble, 1}, libname = fixedlibname)
...
function cjprod(io_err::Array{Cint, 1}, n::Array{Cint, 1},
    m::Array{Cint, 1}, gotj::Array{Cint, 1}, jtrans::Array{Cint, 1},
    x::Array{Cdouble, 1}, vector::Array{Cdouble, 1}, lvector::Array{Cint,
    1}, result::Array{Cdouble, 1}, lresult::Array{Cint, 1}, libname =
    fixedlibname)
